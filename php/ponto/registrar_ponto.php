...
$id_projeto = $_SESSION['id_project'];
...
$result_ponto->bindParam(':projeto_id', $id_projeto);
...
switch ($tipo_registro) {
    ...
    default:
        ...
        $query_horario = "INSERT INTO pontos (data_entrada, entrada, usuario_id, projeto_id) VALUES (:data_entrada, :entrada, :usuario_id, :projeto_id )";
        ...
        $cad_horario->bindParam(':projeto_id', $id_projeto);
        break;
}
...
if ($cad_horario->rowCount()) {
    $_SESSION['msg'] = "<p style='color: green;'>Horário de $text_tipo_registro cadastrado com sucesso no projeto de ID:" . $_SESSION['id_project'] . "!</p>";
    header("Location: ../index.php");
} else {
    $_SESSION['msg'] = "<p style='color: #f00;'>Horário de $text_tipo_registro não cadastrado no projeto de ID:" . $_SESSION['id_project'] . "!</p>";
    header("Location: ../index.php");
}
